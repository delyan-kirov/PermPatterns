...
find ../params/mixed/avoidance/consecutive -type f -print | while read -r file; do
    echo "$file"
    # Copy the found file to the temp folder
    cp ../models/mixed/avoidance/consecutive.essence temp/$folder_name
    ...
    conjure solve -ac --number-of-solutions=all --solver=nbc_minisat_all consecutive.essence "$filename"
...
find ../params/mesh/avoidance/consecutive -type f -print | while read -r file; do
    echo "$file"
    # Copy the found file to the temp folder
